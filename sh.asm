...
_sh:     formato del file elf32-i386
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    tok = gettoken(ps, es, 0, 0);
     8c7:	6a 00                	push   $0x0
     8c9:	6a 00                	push   $0x0
     8cb:	ff 75 10             	pushl  0x10(%ebp)
     8ce:	ff 75 0c             	pushl  0xc(%ebp)
...
00000ef8 <write>:
SYSCALL(write)
     ef8:	b8 15 00 00 00       	mov    $0x15,%eax
     efd:	cd 40                	int    $0x40
     eff:	c3                   	ret    

00000f00 <close>:
SYSCALL(close)
     f00:	b8 1a 00 00 00       	mov    $0x1a,%eax
     f05:	cd 40                	int    $0x40
     f07:	c3                   	ret    
...
00000f20 <mknod>:
SYSCALL(mknod)
     f20:	b8 16 00 00 00       	mov    $0x16,%eax
     f25:	cd 40                	int    $0x40
     f27:	c3                   	ret    

00000f28 <unlink>:
SYSCALL(unlink)
     f28:	b8 17 00 00 00       	mov    $0x17,%eax
     f2d:	cd 40                	int    $0x40
     f2f:	c3                   	ret    
...
00000f78 <sem_alloc>:
SYSCALL(sem_alloc)
     f78:	b8 0f 00 00 00       	mov    $0xf,%eax
     f7d:	cd 40                	int    $0x40
     f7f:	c3                   	ret    

00000f80 <sem_destroy>:
SYSCALL(sem_destroy)
...
00000f88 <sem_init>:
SYSCALL(sem_init)
     f88:	b8 11 00 00 00       	mov    $0x11,%eax
     f8d:	cd 40                	int    $0x40
     f8f:	c3                   	ret    

00000f90 <sem_post>:
SYSCALL(sem_post)
     f90:	b8 12 00 00 00       	mov    $0x12,%eax
     f95:	cd 40                	int    $0x40
     f97:	c3                   	ret    

00000f98 <sem_wait>:
SYSCALL(sem_wait)
     f98:	b8 13 00 00 00       	mov    $0x13,%eax
     f9d:	cd 40                	int    $0x40
     f9f:	c3                   	ret    
